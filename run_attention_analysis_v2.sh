#!/bin/bash
# attention_analysis_v2 — §3.I 自己注意解析 + T1/T2 テスト
# v2 修正: CPU-based attention capture で VRAM 過消費を解消
...
python -m cosmos_policy.experiments.robot.robocasa.analysis.attention_analysis_v2 \
    ...
    --skip_t1_on_fail False \
    --output_dir cosmos_policy/experiments/robot/robocasa/analysis/results/self_attention_v2
