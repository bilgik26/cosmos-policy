#!/bin/bash
# critical_boundary_test.py 本番実行: 全4タスク×2 seed系列でCritical Boundary Detectorを検証。
...
python -m cosmos_policy.experiments.robot.robocasa.analysis.critical_boundary_test \
    ...
    --n_probes_per_episode 2 \
    --probe_call_stride 2 \
    --fine_steps 13 \
    --n_hutchinson_probes 8 \
    --n_convergence_seeds 6 \
    --output_dir cosmos_policy/experiments/robot/robocasa/analysis/results/attractor_verification/critical_boundary
