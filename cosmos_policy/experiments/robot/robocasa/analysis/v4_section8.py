...
実行:
  python -m cosmos_policy.experiments.robot.robocasa.analysis.v4_section8 \
...
from cosmos_policy.experiments.robot.robocasa.analysis.linear_probe import labels_from_progress
