...
run_in_singularity "cosmos_policy/experiments/robot/robocasa/analysis/verification/mechanism/run_mechanism_analysis.sh"
run_in_singularity "cosmos_policy/experiments/robot/robocasa/analysis/verification/collection/run_feature_analysis.sh"
run_in_singularity "cosmos_policy/experiments/robot/robocasa/analysis/verification/attention/run_crossattn_analysis.sh"
run_in_singularity "cosmos_policy/experiments/robot/robocasa/analysis/verification/attention/run_attention_analysis.sh"
run_in_singularity "cosmos_policy/experiments/robot/robocasa/analysis/verification/image_latent/run_image_analysis.sh"

# ── Phase 2: Offline analysis (reads npz files, no simulation) ────────────
echo "=== Phase 2: Offline analysis ==="

run_in_singularity "cosmos_policy/experiments/robot/robocasa/analysis/verification/run_offline_analysis.sh"
