...
python -m cosmos_policy.experiments.robot.robocasa.analysis.verification.representation.layer_analysis \
...
python -m cosmos_policy.experiments.robot.robocasa.analysis.verification.probing.linear_probe \
...
python -m cosmos_policy.experiments.robot.robocasa.analysis.verification.mechanism.dimension_analysis
