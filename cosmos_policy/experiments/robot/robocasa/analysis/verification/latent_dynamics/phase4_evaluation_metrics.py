...
def manifold_deviation(episode_logs, centers, variances, n_bins):
    from cosmos_policy.experiments.robot.robocasa.analysis.verification.attractor.success_failure_trajectory_test import progress_bin
...
def main():
    ...
    from cosmos_policy.experiments.robot.robocasa.analysis.verification.attractor.success_failure_trajectory_test import N_PROGRESS_BINS
