#!/bin/bash
# attractor_verification_design.md 実行: マルチタスク収集 (縮小スコープ)
...
python -m cosmos_policy.experiments.robot.robocasa.analysis.verification.attractor.collect_multitask \
    ...
    --output_dir cosmos_policy/experiments/robot/robocasa/analysis/results/attractor_verification/collect
