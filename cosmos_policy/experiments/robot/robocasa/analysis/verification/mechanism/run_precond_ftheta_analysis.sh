#!/bin/bash
# §3.C F_θ preconditioning analysis
# Captures raw DiT output F_θ before EDM scaling to verify:
#   - ‖F_θ‖/√d distribution across σ
#   - CV% vs Gaussian concentration bound 1/(2√d)
...
python -m cosmos_policy.experiments.robot.robocasa.analysis.verification.mechanism.precond_ftheta_analysis \
