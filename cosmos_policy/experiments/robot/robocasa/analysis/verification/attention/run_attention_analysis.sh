...
# Note: robocasa/models/assets/textures is a symlink to /mnt/data/bilgehan.sakai/tmp_home/...
# That bind is provided via the --bind flag in the singularity exec command.

cd /home/bilgehan.sakai/cosmos-policy
source .venv/bin/activate

python -m cosmos_policy.experiments.robot.robocasa.analysis.verification.attention.attention_analysis \
