...
python3 -m cosmos_policy.experiments.robot.robocasa.analysis.verification.intervention_v3.real_vs_dummy_zeta_distribution \
    ...
    --out_dir cosmos_policy/experiments/robot/robocasa/analysis/results/_smoketest_real_vs_dummy_zeta \
    --task_name PnPCounterToCab --seed 195 --target_layer 13 --target_k 4 --n_pairs 6
