...
python3 -m cosmos_policy.experiments.robot.robocasa.analysis.verification.intervention_v3.observer_minimal_norm_stage3a \
    ...
    --out_dir cosmos_policy/experiments/robot/robocasa/analysis/results/_smoketest_observer_minimal_norm \
    --task_name PnPCounterToCab --seed 195 --target_layer 13 \
    --n_episodes_eval 2 --max_call_eval 6 --conditions off force_open force_closed
