#!/bin/bash
# §5 Null model: random init DiT feature capture + PR/CKA comparison
...
python -m cosmos_policy.experiments.robot.robocasa.analysis.verification.representation.null_model_analysis \
