...
実行:
  python -m cosmos_policy.experiments.robot.robocasa.analysis.verification.probing.v4_section5 \
...
from cosmos_policy.experiments.robot.robocasa.analysis.verification.probing.linear_probe import (
